...
AppCopyright=Copyright (C) 2026 {#MyAppCopyrighter}
...
[Messages]
BeveledLabel={#MyAppName} Online Setup [App Version: {#MyAppVersionText} | Installer Version: {#MySetupVer}]
